...
with codecs.open('src/app/operaciones-grupo-cliente/page.tsx', 'r', encoding='utf-8') as f:
    content = f.read()
...
gt_start = content.find('{/* 📈 Grand total 📈 */}')
if gt_start == -1: gt_start = content.find('{/* 📊 Grand total 📊 */}')
if gt_start == -1: gt_start = content.find('{/* ── Grand total ── */}')
...
"""
    content = content[:gt_start] + old_gt + content[end_sections:]

with codecs.open('src/app/operaciones-grupo-cliente/page.tsx', 'w', encoding='utf-8') as f:
    f.write(content)
