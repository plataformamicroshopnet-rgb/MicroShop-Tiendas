                ...
                {sortedCards.map((c: any, i: number) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="card-icon-wrapper" style={c.href ? { backgroundColor: 'rgba(99, 102, 241, 0.1)', color: '#6366F1' } : c.isSub ? { backgroundColor: 'rgba(107, 114, 128, 0.1)', color: 'var(--text-muted)' } : { backgroundColor: 'rgba(37, 99, 235, 0.1)', color: '#2563eb' }}>
