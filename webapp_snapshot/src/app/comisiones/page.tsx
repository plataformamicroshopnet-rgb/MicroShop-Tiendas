                        ...
                        <div key={s.name} style={{ display: 'flex', flexDirection: 'column' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                ...
                                <div style={{ flex: 1 }}>
                                    ...
                                    <table className="comisiones-table" style={{ width: '100%', borderCollapse: 'collapse', fontSize: 9.5 }}>
                                        <thead>
                                            <tr style={{ 
                                                ...
                                                <th style={{ padding: '4px 7px', textAlign: 'left', fontWeight: 700 }}>Nombre Comisión</th>
                                                <th style={{ padding: '4px 4px', textAlign: 'center', fontWeight: 700 }}><AuditableCell metricKey="COMISION_INDIVIDUAL_TRAMO">Importe<br/>Primer Tramo</AuditableCell></th>
                                                <th style={{ padding: '4px 4px', textAlign: 'center', fontWeight: 700 }}><AuditableCell metricKey="COMISION_INDIVIDUAL_TRAMO">Importe<br/>Segundo Tramo</AuditableCell></th>
                                                <th style={{ padding: '4px 4px', textAlign: 'center', fontWeight: 700 }}>Ventas</th>
                                                <th style={{ padding: '4px 4px', textAlign: 'center', fontWeight: 700 }}>Pte.</th>
                                                <th style={{ padding: '4px 4px', textAlign: 'center', fontWeight: 700 }}>Obj. 1</th>
                                                <th style={{ padding: '4px 4px', textAlign: 'center', fontWeight: 700 }}>Obj. 2</th>
                                                <th style={{ padding: '4px 4px', textAlign: 'center', fontWeight: 700 }}>Falta 1</th>
                                                <th style={{ padding: '4px 4px', textAlign: 'center', fontWeight: 700 }}>Falta 2</th>
                                                <th style={{ padding: '4px 7px', textAlign: 'right', fontWeight: 700 }}>Comisión</th>
                                            </tr>
                                        </thead>
                                        <tbody style={{ backgroundColor: '#ffffff' }}>
                                            {(() => {
                                                ...
                                                return (
                                                    ...
                                                    <tr style={{ backgroundColor: rowBg, borderBottom: '1px solid #e2e8f0', transition: 'background 0.2s', color: '#334155' }}>
                                                        <td style={{ padding: '4px 7px', fontSize: 9, fontWeight: 700, color: '#0f172a' }}>
                                                        ...
                                                        <td style={{ padding: '4px 4px', textAlign: 'center', fontSize: 9, color: '#334155' }}>
                                                            {formatImporteTramo(rule.importePrimerTramo)}
                                                        </td>
                                                        <td style={{ padding: '4px 4px', textAlign: 'center', fontSize: 9, color: '#334155' }}>
                                                            {formatImporteTramo(rule.importeSegundoTramo)}
                                                        </td>
                                                        <td style={{ padding: '4px 4px', textAlign: 'center', fontSize: 10, fontWeight: 800, color: '#2563eb', backgroundColor: 'rgba(37, 99, 235, 0.05)' }}>
                                                            {formatQtty(qtty)}
                                                        </td>
                                                        <td style={{ padding: '4px 4px', textAlign: 'center', fontSize: 9, fontWeight: 700, color: '#f59e0b', backgroundColor: 'rgba(245, 158, 11, 0.05)' }}>
                                                            {pendingQtty > 0 ? formatQtty(pendingQtty) : '-'}
                                                        </td>
                                                        <td style={{ padding: '4px 4px', textAlign: 'center', fontSize: 9 }}>
                                                            {obj1 === 0 ? '-' : format(obj1)}
                                                        </td>
                                                        <td style={{ padding: '4px 4px', textAlign: 'center', fontSize: 9 }}>
                                                            {displayObj2 === 0 ? '-' : <>{format(displayObj2)} {isTeamObj2 && <span style={{ fontSize: 7, color: 'var(--medium-gray)' }}>(Eq)</span>}</>}
                                                        </td>
                                                        <td style={{ padding: '4px 4px', textAlign: 'center', fontSize: 9, fontWeight: 600 }}>
                                                            ...
                                                            <tr key={`terr-${rIdx}`} style={{ backgroundColor: '#ffffff' }}>
                                                                <td colSpan={10} style={{ padding: '0 0 10px 0' }}>
                                                                    <div style={{ margin: '0', border: '1px solid #38bdf8', borderRadius: '0' }}>
                                                                        <div style={{ backgroundColor: '#38bdf8', color: 'white', padding: '4px 8px', fontWeight: 800, fontSize: '9.5px', textTransform: 'uppercase', letterSpacing: '0.5px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                                                            <span>TERRITORIAL O2 MOVILFREE</span>
                                                                            <span style={{ fontSize: '8px', fontWeight: 700, backgroundColor: 'rgba(255,255,255,0.2)', padding: '1px 4px', borderRadius: '12px', textTransform: 'none', letterSpacing: '0' }}>A nivel informativo</span>
                                                                        </div>
                                                                        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                                                                            <thead>
                                                                                <tr style={{ backgroundColor: '#0284c7', color: 'white', fontSize: '8.5px', fontWeight: 700 }}>
                                                                                    {TRAMOS_MES.map(t => <th key={t.key} style={{ padding: '4px 2px', textAlign: 'center', width: '9%' }}>{t.label}</th>)}
                                                                                    {TRAMOS_TRIM.map(t => <th key={t.key} style={{ padding: '4px 2px', textAlign: 'center', width: '9%' }}>{t.label}</th>)}
                                                                                    <th style={{ padding: '4px 2px', textAlign: 'center', width: '9%' }}>Conect.</th>
                                                                                    <th style={{ padding: '4px 2px', textAlign: 'center', width: '19%' }}>VENTAS TOTAL O2</th>
                                                                                </tr>
                                                                            </thead>
                                                                            <tbody>
                                                                                <tr style={{ borderBottom: '1px solid #e2e8f0', backgroundColor: '#ffffff' }}>
                                                                                    {TRAMOS_MES.map(t => (
                                                                                        <td key={t.key} style={{ padding: '5px 2px', textAlign: 'center', fontSize: '9.5px' }}>
                                                                                    ...
                                                                                    <td style={{ padding: '5px 2px', textAlign: 'center', fontSize: '9.5px' }}>
                                                                                        {renderCell(rule.conectividad, totalSales > 0 && !!rule.conectividad)}
                                                                                    </td>
                                                                                    <td style={{ padding: '5px 2px', textAlign: 'center', fontSize: '11.5px', fontWeight: 800, color: '#0284c7' }}>
                                            ...
                                            {s.extraGroups && s.extraGroups.length > 0 && s.extraGroups.filter((eg: any) => !String(eg.name).includes('TERRITORIAL O2 MOVILFREE')).map((eg: any, idx: number) => {
                                                ...
                                                <tr key={`extra-${idx}`} style={{ borderBottom: '1px solid #e2e8f0', backgroundColor: '#ecfdf5', transition: 'background 0.2s', color: '#065f46' }}>
                                                    <td style={{ padding: '4px 7px', fontSize: 9, fontWeight: 700, display: 'flex', alignItems: 'center', gap: 4 }}>
                                                        <Trophy size={10} color="#10b981" /> {safeName}
                                                    </td>
                                                    <td style={{ padding: '4px 3px', textAlign: 'center', fontSize: 10, fontWeight: 800, color: '#10b981' }}>
                                                        {eg.count}
                                                    </td>
                                                    <td colSpan={7} style={{ padding: '4px 3px', textAlign: 'center', fontSize: 9, color: '#a7f3d0' }}>
                                                        N/A
                                                    </td>
                                                    <td style={{ padding: '4px 7px', textAlign: 'right', fontSize: 10, fontWeight: 800, color: '#10b981' }}>
