              ...
              <div key={k.id} style={subCard}>
                ...
                <div style={{ marginTop: 10, maxWidth: 280 }}>
                  ...
                  <div style={{ fontSize: 11.5, color: 'var(--medium-gray)', marginTop: 4 }}>
                    0 = automático: el termómetro enseña un medidor por cada objetivo del mes
                    (1º, 2º y 3º si la palanca los tiene — «el del 100% y el del 115%»). Con un
                    número aquí, un solo medidor con este objetivo.
                  </div>
                </div>
              </div>
            ))}
